...
#define _TOKENLIST_TOKEN_TYPE_ENUM \
    ...
    ENUM_ENTRY(TOKEN_LEFT_CURLY_BRACE)  \
    ENUM_ENTRY(TOKEN_RIGHT_CURLY_BRACE) \
...
typedef char* TokenStream;
typedef char SingleCharacterToken;
...
extern const char* _tokens_get_token_by_enum(TokenType _enum);
